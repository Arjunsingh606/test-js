                                ...
                                <Form className="signup-form">
                                    <div className="form-field" >
                                        ...
                                        <Field
                                            ...
                                            name="firstName"
                                            placeholder=""
                                            className={errors.firstName && touched.firstName ? "error-border" : ""}
                                            onChange={(e: any) => {
                                                handleChange(e);
                                    ...
                                    <div className="form-field" >
                                        ...
                                        <Field
                                            ...
                                            onBlur={handleBlur}
                                            className={  errors.lastName && touched.lastName ? "error-border"  : "" }
                                        />
                                    ...
                                    <div  className="form-field"   >
                                        ...
                                        <Field
                                            ...
                                            onBlur={handleBlur}
                                            className={ errors.role && touched.role ? "error-border" : ""  } >
